					...
					<div class="row">
						...
						<div class="col-6 ">
							<form class="border border-secondary p-4 "
								...
								<p class="h3 mb-4 text-primary">Add Book</p>
								<hr />
								<br />
								<div class="form-row">
									<div class="form-group col-md-6">
										<label for="book-name">Book Name</label> <input type="text"
											class="form-control" name="book-name" required>
									</div>
									<div class="form-group col-md-6">
										<label for="category">Category</label> <select
											class="browser-default custom-select" name="category">
								...
								<div class="form-row">
									<div class="form-group col-md-6">
										<label for="rent-lend">Rent/Lend</label> <select
											class="browser-default custom-select" name="rent-lend"
											required>
								...
								<div class="form-row">
									<div class="form-group col-md-6">
										<label for="copies">No of Copies</label> <input type="number"
											class="form-control" name="copies" required>
									</div>
								</div>
